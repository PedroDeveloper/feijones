...
export default {
    ...
    methods: {
        ...
        async enviarFormulario () {
            await axios.post(`https://feijoneswebapi.azurewebsites.net/api/clienteendereco/${this.chave}`, {
        ...
        async editarFormulario () {
            await axios.put(`https://feijoneswebapi.azurewebsites.net/api/endereco/${this.enderecoDados.iD_end}`, { 
